...
import { DEFAULT_CONTEXT, JWTService, KeyDIDMethod, SCHEMA_VALIDATOR, SchemaManager, VERIFIABLE_CREDENTIAL, VERIFIABLE_PRESENTATION, getSupportedResolvers } from '../../../src/services/common'
